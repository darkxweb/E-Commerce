...
function home() {
   ...
   document.getElementById("home").style.color = "#9333FF;";
...
function shop() {
   ...
   document.getElementById("blog").style.color = "black";
   document.getElementById("about").style.color = "black";
   document.getElementById("shop").style.color = "#9333FF;"
...
function blog() {
   ...
   document.getElementById("blog").style.color = "#9333FF;";
   document.getElementById("home").style.color = "black"
   document.getElementById("shop").style.color = "black"
   document.getElementById("about").style.color = "black";
   document.getElementById("contact").style.color="black";
...
function about() {
   ...
   document.getElementById("home").style.color = "black"
   document.getElementById("shop").style.color = "black";
   document.getElementById("about").style.color = "#9333FF;"
   document.getElementById("contact").style.color="black";
...
function contact() {
   ...
   document.getElementById("shop").style.color = "black";
   document.getElementById("about").style.color = "black";
   document.getElementById("contact").style.color="#9333FF;"
